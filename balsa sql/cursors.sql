create or replace procedure friendships_details is 
    ...
    cursor friendly_players is select distinct account_id from account;
...
begin
    ...
    LOOP
        ...
        if total_friends = 1 then
            DBMS_OUTPUT.put_line('  No friends');        
        end if;
        CLOSE friend_list;
    end loop;
